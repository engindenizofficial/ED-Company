...
export const dictionaries: Record<Locale, Record<string, unknown>> = {
  tr: {
    ...
    duel: {
      ...
      chooseLeaguesDesc: "Rakiplerin hangi liglerden çıkacağını sen belirle. İstersen hepsini bırak.",
  ...
  en: {
    ...
    duel: {
      ...
      chooseLeaguesDesc: "Decide which leagues your opponents come from. Or just leave them all in.",
