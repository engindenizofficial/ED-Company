...
export function MarketValueDuelGame() {
  ...
  }, [bestStreak, correctCount, dailyAnswers, dailyRounds, difficulty, lives, loadRound, mode, play, prefetchedRound, roundNumber, score, seenPlayerIds, selectedLeagueIds, session, t])
