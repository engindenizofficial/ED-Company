...
export function GamesHubContent({ isAdmin }: { isAdmin: boolean }) {
  const { t } = useLanguage()
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-5 py-6">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {/* "Kulübünü Kur" henüz yayına hazır değil — sadece admin hesabına
              görünür. Sayfanın kendisi de (app/oyunlar/kulubunu-kur/page.tsx)
              admin olmayanları ana sayfaya geri yönlendirir; burası sadece
              kartı listeden gizleyerek tıklanabilir bir bağlantı bırakmaz. */}
          {isAdmin ? (
            <Link
