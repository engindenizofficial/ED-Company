...
function TeamLogo({ logo, name }: { logo: string; name: string }) {
  return logo ? (
    ...
    <img src={logo} alt={name} title={name} className="mx-auto h-5 w-5 rounded-full bg-white/95 object-contain p-0.5 ring-1 ring-black/5" width={20} height={20} loading="lazy" decoding="async" />
  ) : (
...
function useLeagueSection<T>(leagueId: number, section: string, open: boolean) {
  ...
  }, [open, leagueId, section, retryKey, t])
                ...
                >
                  <div className="flex min-w-0 flex-1 flex-col gap-1">
                    ...
                    <div className="flex items-center gap-1.5 truncate">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img src={f.home.logo} alt="" className="h-4 w-4 shrink-0 object-contain rounded-full bg-white/95 p-0.5 ring-1 ring-black/5" width={16} height={16} loading="lazy" decoding="async" />
                      ...
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img src={f.away.logo} alt="" className="h-4 w-4 shrink-0 object-contain rounded-full bg-white/95 p-0.5 ring-1 ring-black/5" width={16} height={16} loading="lazy" decoding="async" />
      ...
      <div className="flex h-full w-full flex-col overflow-hidden">
        ...
        <div className="shrink-0 bg-card" {...swipeHandlers}>
          ...
          {league.logo ? (
            ...
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-white p-2 shadow-sm ring-1 ring-border/40">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={league.logo}
                alt={league.name}
